  ...
  return (
    <div className="animate-fade-in space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Interactive Live Workforce Roster Component (Search, Status Filters, Paginated) */}
        <div className="lg:col-span-8">
          <LiveWorkforceRoster
            liveRoster={roster.map((r) => ({ ...r, outletName, distanceMeters: null, hasFlags: r.flagged }))}
          />
        </div>
      </div>
    </div>
