...
export function LiveWorkforceRoster({ liveRoster, outlets = [] }: LiveWorkforceRosterProps) {
  ...
  // Extract unique outlet names from roster if not explicitly provided
